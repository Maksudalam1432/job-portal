...
import { Bookmark, MapPin, Briefcase, Info } from "lucide-react";
  ...
  return (
    <div className="bg-white border rounded-xl p-5 shadow-md hover:shadow-xl transition hover:scale-[1.02] m-4">
      ...
      <div className="flex justify-between items-center mb-3">
        ...
        />
        <Bookmark size={22} className="cursor-pointer hover:text-gray-700" />
      </div>
      ...
      <div className="flex gap-3 mt-5">
        <button
          ...
          className="w-1/2 border border-gray-700 text-gray-800 py-2 rounded-lg
        ...
        >
          <Briefcase size={18} /> Save For Later
        </button>
      </div>
